...
var APIAdapter = /** @class */ (function () {
    function APIAdapter(endpoint, transformer) {
     ...
     */
    APIAdapter.prototype.setAPIService = function (service) {
        this.apiService = service;
    };
    APIAdapter.prototype.create = function (model) {
        if (!this.apiService) {
     ...
     */
    APIAdapter.prototype.createSingle = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.apiService.post(this.endpoint, this.transformer(model)).then(function (data) {
     ...
     */
    APIAdapter.prototype.createList = function (models) {
        return __awaiter(this, void 0, void 0, function () {
            var promises, _i, models_1, model;
            return __generator(this, function (_a) {
                promises = [];
